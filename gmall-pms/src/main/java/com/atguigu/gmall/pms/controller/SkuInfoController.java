...
public class SkuInfoController {
    ...
    @GetMapping("{gid}")
    public Resp<List<SkuInfoEntity>> querySkuByGid(@PathVariable("gid")Long gid){
        List<SkuInfoEntity> skuInfoEntityList = skuInfoService.list(new QueryWrapper<SkuInfoEntity>().eq("spu_id",gid));
